...
function Home() {
    ...
    useEffect(() => {
        ...
        axios.get('https://backend.jobhub.company/api/jobs/getList')
            .then(response => {
        ...
        axios.get('https://backend.jobhub.company/api/getApplicantList')
            .then(response => {
        ...
        axios.get('https://backend.jobhub.company/api/getRecruiterList')
            .then(response => {
